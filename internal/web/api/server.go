...
type Movie struct {
	Id   *uint64 `json:"id,omitempty"`
	Name string  `json:"name" validate:"required"`
	Year uint16  `json:"year" validate:"required,min=1888"`
}
...
type PutCharactersCharacterId204Response struct {
}

func (response PutCharactersCharacterId204Response) VisitPutCharactersCharacterIdResponse(w http.ResponseWriter) error {
	w.WriteHeader(204)
	return nil
}
...
type PutMoviesMovieId204Response struct {
}

func (response PutMoviesMovieId204Response) VisitPutMoviesMovieIdResponse(w http.ResponseWriter) error {
	w.WriteHeader(204)
	return nil
}
